...
export default function ProfilePage() {
  ...
  const recentActivity = [
    { action: 'Добавил в избранное', place: 'Парк Ленинского комсомола', time: '2 часа назад', icon: '⭐' },
    { action: 'Оставил отзыв', place: 'Ресторан "У Федора"', time: '1 день назад', icon: '💬' },
    { action: 'Построил маршрут', place: 'Донецкий ботанический сад', time: '3 дня назад', icon: '🧭' }
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <main className="container py-6">
        ...
        <div className="dark-card rounded-2xl p-6 text-center mb-6">
          ...
          <h2 className="text-xl font-bold text-white mb-2">Алексей Петров</h2>
              ...
              <div key={index} className="dark-card rounded-xl p-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-slate-400 text-sm">{activity.place}</div>
                  </div>
        ...
        <div className="container">
          <div className="flex justify-around py-3">
            {[
              ...
              { id: 'profile', icon: '👤', label: 'Профиль', href: '/profile', active: true },
