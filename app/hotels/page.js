              ...
              <div className="mb-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between text-sm text-gray-600">
                    <span>500 ₽</span>
                    <span className="font-semibold text-blue-600">до {priceRange[1]} ₽</span>
                    <span>10000 ₽</span>
                  </div>
                </div>
              </div>
          ...
          <main className="lg:col-span-3">
                ...
                >
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className={`md:w-1/3 h-48 md:h-auto relative overflow-hidden ${
                      ...
                      index % 3 === 1 ? 'gradient-lavender' : 'gradient-mint'
                    }`}>
                      ...
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-sm text-gray-500">• {location.type || 'Отель'}</span>
                          </div>
                        </div>
                        <div className="text-right">
                          <div className="text-2xl font-bold text-blue-600">от 2 500 ₽</div>
            ...
            {hotelLocations.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-xl font-semibold text-gray-700 mb-2">Пока нет отелей</h3>
                <p className="text-gray-500">Скоро здесь появятся лучшие отели Донецка</p>
              </div>
            )}
          </main>
        </div>
